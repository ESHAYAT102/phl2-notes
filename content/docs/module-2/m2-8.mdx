---
title: "Scenario-Based Activity: Aggregating Data"
description: "Lesson 2.8: Scenario-Based Activity: Aggregating Data."
---
...
To get that output we first need a variable containing the function (reduce).

```js
const output = sales.reduce(() => {}, {});
```

Then we need to name the parameters that we want to receive.
