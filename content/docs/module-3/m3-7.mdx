---
title: "Linked List Implementation: Append() and Print()"
description: "Lesson 3.7: Linked List Implementation: Append() and Print()."
---
...
This code adds the new node, and now let's replace the tail value/identity:
