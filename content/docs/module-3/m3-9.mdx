---
title: "Linked List Implementation: Insert()"
description: "Lesson 3.9: Linked List Implementation: Insert()."
---
...
Moved the function for `mid` case to a separate function for better code.
Added `_` before the extra function is because we don't want it to be used out of the class. So basically to let the developer know that this shouldn't be used outside the class.

---

The `remove` method will be done in the next module.
