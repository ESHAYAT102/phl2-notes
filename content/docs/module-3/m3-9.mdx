...
As we have kinda managed the indexes in the previous module, we will manage it further and then we'll start managing the values.

### Creating the methods

#### Creating the insert method

Properly handling the indexes of the `mid` case:
